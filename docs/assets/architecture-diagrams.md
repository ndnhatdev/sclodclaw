# RedClaw Architecture Diagrams

This document provides visual representations of RedClaw's architecture, execution modes, and data flows.

---

## 1. Execution Modes

**Ways RedClaw can be run:**

```mermaid
flowchart TD
    Start[redclaw CLI] --> Onboard[onboard<br/>Setup wizard]
...
```mermaid
flowchart TB
    Start[[redclaw daemon]] --> SpawnComponents
...
```mermaid
flowchart TB
    Client[HTTP Client] --> Gateway[RedClaw Gateway]
...
flowchart TB
    ...
    Defaults --> EnvOverrides[apply_env_overrides<br/>REDCLAW_* env vars]
...
*Generated for RedClaw v0.1.0 - Architecture Documentation*
