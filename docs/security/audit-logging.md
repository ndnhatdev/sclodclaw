...
## Problem
RedClaw logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/redclaw/audit.key"
...
redclaw audit --user @alice

# Show all high-risk commands
redclaw audit --risk high

# Show violations from last 24 hours
redclaw audit --since 24h --violations-only

# Export to JSON for analysis
redclaw audit --format json --output audit.json
