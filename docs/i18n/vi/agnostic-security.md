...
|---------|-----------|--------------|--------|
| **RedClaw cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | RedClaw (cơ bản) | RedClaw (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, RedClaw chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của RedClaw: hoán đổi bất kỳ thứ gì
