...
Cách cài đặt và khởi tạo RedClaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài RedClaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image RedClaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.redclaw-docker`.
