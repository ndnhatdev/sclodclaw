# RedClaw PR Workflow (High-Volume Collaboration)

This document defines how RedClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to RedClaw/project-native labels.
...
- Confirm any required identity-like wording uses RedClaw/project-native terminology.
