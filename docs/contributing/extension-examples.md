...
RedClaw's architecture is trait-driven and modular.
...
```rust
// In your crate: use redclaw::tools::traits::{Tool, ToolResult};
...
Channels let RedClaw communicate through any messaging platform.
...
```rust
// In your crate: use redclaw::channels::traits::{Channel, ChannelMessage, SendMessage};
...
Providers are LLM backend adapters. Each provider connects RedClaw to a different model API.
...
```rust
// In your crate: use redclaw::providers::traits::Provider;
...
```rust
// In your crate: use redclaw::memory::traits::{Memory, MemoryEntry, MemoryCategory};
