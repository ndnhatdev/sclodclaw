# RedClaw Contributor License Agreement (CLA)
...
property rights granted by contributors to RedClaw Labs. This agreement
protects both contributors and users of the RedClaw project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the RedClaw repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to RedClaw Labs
  for inclusion in the RedClaw project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"RedClaw Labs"** means the maintainers and organization responsible
  for the RedClaw project at https://github.com/redclaw-labs/redclaw.

---

## 2. Grant of Copyright License

You grant RedClaw Labs and recipients of software distributed by RedClaw
...
RedClaw that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to RedClaw
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with RedClaw Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the RedClaw name,
...
RedClaw Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the RedClaw project are licensed under
both:
...
By opening a pull request or submitting a patch to the RedClaw repository,
...
https://github.com/redclaw-labs/redclaw/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the RedClaw dual-license model.*
