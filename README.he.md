...
<p align="center" dir="rtl">
RedClaw הוא תשתית עוזר AI קלת משקל, מוטטבילית וניתנת להרחבה שנבנתה ב-Rust. היא מחברת ספקי LLM שונים (Anthropic, OpenAI, Google, Ollama, וכו') דרך ממשק מאוחד ותומכת בערוצים מרובים (Telegram, Matrix, CLI, וכו').
</p>
...
<p align="center" dir="rtl">
RedClaw משתמש בקובץ קונפיגורציה YAML. כברירת מחדל, הוא מחפש `config.yaml`.
</p>
...
<p align="center" dir="rtl">
אם RedClaw שימושי עבורך, אנא שקול לקנות לנו קפה:
</p>
