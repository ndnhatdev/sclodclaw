"""
Discord bot integration for RedClaw.
"""
...
class DiscordBot:
    """
    Discord bot powered by RedClaw agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install redclaw-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"RedClaw Discord Bot ready: {self.client.user}")
