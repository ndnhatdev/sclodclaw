...
Python companion package for [RedClaw](https://github.com/redclaw-labs/redclaw) — LangGraph-based tool calling for consistent LLM agent execution.
...
| Feature | Rust RedClaw | redclaw-tools |
|---------|---------------|----------------|
...
Use **Rust RedClaw** for production edge deployments. Use **redclaw-tools** when you need guaranteed tool calling consistency or Python ecosystem integration.
