import { EVENTS_STREAM_PATH, type ClientEvent } from '@/sdk/client-types';
import { getToken } from './auth';

export type SSEEventHandler = (event: ClientEvent) => void;
...
/**
 * SSE client that connects to the RedClaw event stream.
 *
...
export class SSEClient {
  ...
  constructor(options: SSEClientOptions = {}) {
    this.path = options.path ?? EVENTS_STREAM_PATH;
  ...
  private parseEvent(raw: string): void {
    ...
    try {
      parsed = JSON.parse(dataStr) as ClientEvent;
