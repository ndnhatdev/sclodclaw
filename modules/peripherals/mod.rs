...
/// Handle `redclaw peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: redclaw peripheral add <board> <path>");
                println!("  Example: redclaw peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
