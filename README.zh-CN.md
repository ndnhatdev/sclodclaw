...
| 日期（UTC） | 级别 | 通知 | 处理建议 |
|---|---|---|---|
| 2026-02-19 | _紧急_ | 我们与 `openagen/redclaw` 及 `redclaw.org` **没有任何关系**。`redclaw.org` 当前会指向 `openagen/redclaw` 这个 fork，并且该域名/仓库正在冒充我们的官网与官方项目。 | 请不要相信上述来源发布的任何信息、二进制、募资活动或官方声明。请仅以[本仓库](https://github.com/redclaw-labs/redclaw)和已验证官方社媒为准。 |
| 2026-02-21 | _重要_ | 我们的官网现已上线：[redclawlabs.ai](https://redclawlabs.ai)。感谢大家一直以来的耐心等待。我们仍在持续发现冒充行为，请勿参与任何未经我们官方渠道发布、但打着 RedClaw 名义进行的投资、募资或类似活动。 | 一切信息请以[本仓库](https://github.com/redclaw-labs/redclaw)为准；也可关注 [X（@redclawlabs）](https://x.com/redclawlabs?s=21)、[Telegram（@redclawlabs）](https://t.me/redclawlabs)、[Facebook（群组）](https://www.facebook.com/groups/redclaw)、[Reddit（r/redclawlabs）](https://www.reddit.com/r/redclawlabs/) 与 [小红书账号](https://www.xiaohongshu.com/user/profile/67cbfc43000000000d008307?xsec_token=AB73VnYnGNx5y36EtnnZfGmAmS-6Wzv8WMuGpfwfkg6Yc%3D&xsec_source=pc_search) 获取官方最新动态。 |
...
RedClaw 是一个高性能、低资源占用、可组合的自主智能体运行时。RedClaw 是面向智能代理工作流的**运行时操作系统** — 它抽象了模型、工具、记忆和执行层，使代理可以一次构建、随处运行。
...
<p align="center">
  <img src="docs/assets/redclaw-comparison.jpeg" alt="RedClaw vs OpenClaw 对比图" width="800" />
</p>
...
- Release 二进制：`8.8M`
- `redclaw --help`：约 `0.02s`，峰值内存约 `3.9MB`
- `redclaw status`：约 `0.01s`，峰值内存约 `4.1MB`
...
<p align="center">
  <img src="docs/assets/architecture.svg" alt="RedClaw 架构图" width="900" />
</p>
