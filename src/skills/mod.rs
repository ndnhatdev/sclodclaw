...
const OPEN_SKILLS_SYNC_MARKER: &str = ".redclaw-open-skills-sync";
const OPEN_SKILLS_SYNC_INTERVAL_SECS: u64 = 60 * 60 * 24 * 7;

/// A skill is a user-defined or community-built capability.
/// Skills live in `~/.redclaw/workspace/skills/<name>/SKILL.md`
...
"#,
    ...
    fn skills_dir_path() {
        ...
        assert_eq!(dir, PathBuf::from("/home/user/.redclaw/skills"));
    }
