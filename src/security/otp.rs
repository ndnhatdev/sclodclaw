...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(redclaw_dir);
...
pub fn secret_file_path(redclaw_dir: &Path) -> PathBuf {
    redclaw_dir.join(OTP_SECRET_FILE)
}
