# RedClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for RedClaw edge scenarios on ESP32.
...
3. Connect UI state with RedClaw edge/runtime messaging
...
- [RedClaw Hardware Design](../../docs/hardware/hardware-peripherals-design.md)
