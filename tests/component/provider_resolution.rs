...
use redhorse::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
use redhorse::providers::{
...
fn factory_resolves_openai_codex_provider() {
    let options = redhorse::providers::ProviderRuntimeOptions::default();
