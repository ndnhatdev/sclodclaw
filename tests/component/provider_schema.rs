...
use redhorse::providers::compatible::AuthStyle;
use redhorse::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use redhorse::providers::compatible::OpenAiCompatibleProvider;
