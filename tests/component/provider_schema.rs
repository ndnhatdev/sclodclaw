...
use redclaw::providers::compatible::AuthStyle;
use redclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use redclaw::providers::compatible::OpenAiCompatibleProvider;
