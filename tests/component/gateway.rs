...
//! verification) in isolation. The gateway module (`redhorse::gateway`) exposes
...
use redhorse::gateway::verify_whatsapp_signature;
...
fn gateway_body_limit_is_reasonable() {
    assert_eq!(
        redhorse::gateway::MAX_BODY_SIZE,
        65_536,
...
fn gateway_timeout_is_reasonable() {
    assert_eq!(
        redhorse::gateway::REQUEST_TIMEOUT_SECS,
        30,
...
fn gateway_rate_limit_window_is_60s() {
    assert_eq!(
        redhorse::gateway::RATE_LIMIT_WINDOW_SECS,
        60,
